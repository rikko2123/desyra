...
function NavBar({category, setCategory}) {
    ...
    const aboutuslink = ['Our Story', 'Brand', 'Philantrophy']
    const nav_element=[
        {type: 'link', label: 'Shop', href: '/shop'},
        {type: 'link', label: 'About us', href: '/about-us', otherlink: aboutuslink},
    ...
    return (
        <>
            ...
            <HiddenMenu category={category} setHover={setHover} hover={hover}/>
